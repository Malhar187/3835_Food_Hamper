...
def rag_chatbot_page():
    ...
    # Streamlit button to trigger the chatbot
    if st.button("Ask", key="ask_button", help="Click to get a response", use_container_width=True):
        if user_input:
            ...
            best_match = documents.iloc[best_match_idx]  # Use .iloc for accessing rows
