...
def predict_hamper_pickups(input_features):
    ...
    exog_columns = [
        ...
        'special_occasion_Rabi al-Awwal', 'special_occasion_Rajab',
    ...
    for date in forecast_dates:
        ...
        # Handle special occasions manually if any are known
        # Optional: If your UI allows users to input special occasion
        #           you could also use input_features["special_occasion"]
    ...
    prediction_df = pd.DataFrame({
        "Date": forecast_dates,
        "Predicted Pickups": forecast.values
    })
